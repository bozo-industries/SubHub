...
public final class AppShortcuts {
    public static final String ACTION_START_PROTECTION = "com.betasafe.app.action.SHORTCUT_PROTECT";
    public static final String ACTION_OPEN_BROWSER = "com.betasafe.app.action.SHORTCUT_BROWSER";
