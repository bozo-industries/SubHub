...
| Achievements, progress, and unlock presentation | `AchievementManager`, generated badge art | All 42 recovered conditions plus 14 SubHub-native feature milestones are implemented with persistent unlock/pending-notice state. Every one of the 56 entries has original illustrated medallion art, grouped progress cards, a compact Home preview, and a themed unlock card; API 35 catalog UI emulator-validated |
