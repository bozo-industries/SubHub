...
| --- | --- |
| `app/src/main/res/drawable-nodpi/subhub_demoness_guardian.png` | Original elegant adult purple demoness privacy guardian holding a dark shield; polished vector-like digital illustration, deep plum/electric magenta/violet palette, strong small-size silhouette, transparent background, no text or explicit nudity. |
| `app/src/main/res/drawable-nodpi/subhub_gothic_header.png` | Original wide near-black/ultraviolet gothic zine-collage background with privacy shields, censor bars, horn silhouettes, chains, skull-lace motifs, neon hearts, distressed grain, and a calm center for UI copy; no people or readable text. |
| `app/src/main/assets/popup_storm/guardian_shield.png` | Original square underground screen-print collage with a horned shadow behind a shield and censor bars, chains, skull lace, dripping hearts, scratches, and magenta sparks; no text, copied characters, or explicit imagery. |
...
| `docs/brand/achievement-badge-atlas.png` | Original twelve-family visual seed for the achievement system: censoring, protected time, sessions, streaks, App Mode, limits, timed protection, Hardcore, Wallet, browser, personalisation, and the final badge. |
| `app/src/main/res/drawable-nodpi/achievement_badge_<achievement-id>.webp` | Sixty distinct transparent gothic medallions, one for every achievement. Related milestones preserve a shared central motif while their tiers progress through richer rings, materials, jewels, rays, chains, or crowns. The four cumulative-payment badges form a purse-and-token family that progresses through silver, gold, gems, and a crown. Deep plum, ultraviolet, silver, gold, and hot-magenta enamel; readable at small UI sizes; no copied characters, text, nudity, logos, or currency marks. |
| `docs/brand/achievement-badge-catalog.png` | Deterministic contact sheet rendered from the 60 final app resources by `scripts/render_achievement_badge_catalog.py`; also validates catalog coverage, unique file hashes, 192×192 dimensions, and transparent corners. |
