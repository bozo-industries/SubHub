...
| `docs/brand/achievement-badge-atlas.png` | Original visual seed for the achievement system: censoring, protected time, sessions, streaks, App Mode, limits, timed protection, Hardcore, Wallet, personalisation, and the final badge. |
